...
das = SSDRealDataset(annotation_json="/home/users/b/bozianu/work/data/real/real_anns.json",is_test=True)#MORE DATA!
...
dt = np.dtype([('event_no', 'i4'), ('h5file', 'i4'), ('extent', 'f8', (4)),
               ('t_boxes', 'f4', (30,4)), ('p_boxes', 'f4', (40, 4)), ('p_scores', 'f4', (40))])
...
for step, (batch_imgs, tru_boxes, extents, h5files, h5event_nos) in enumerate(test_dal):
    ...
    t_boxes = [np.pad(trub, ((0,30-len(trub)),(0,0)), 'constant', constant_values=(0)) for trub in tru_boxes]
