...
save_loc = "/home/users/b/bozianu/work/SSD/SSD/cached_metrics/"
...
for file,name in zip(files,names):
    ...
    ax1.hist(total_delta_n,histtype='step',bins=np.arange(-5,20,step=1),label=name)
    ax2.hist(total_n_unmatch_truth,histtype='step',bins=np.arange(0,20,step=1),label=name)
    ax3.hist(total_n_unmatch_pred,histtype='step',bins=np.arange(0,20,step=1),label=name)
    ax4.hist(total_area_cov,histtype='step',bins=np.arange(0,1,step=0.025),label=name)
    ax5.hist(total_centre_diff,histtype='step',bins=np.arange(0,10,step=0.2),label=name)
    ax6.hist(total_h_diff,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)
    ax7.hist(total_w_diff,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)

    ax8.hist(total_area_cov_filter,histtype='step',bins=np.arange(0,1,step=0.025),label=name)
    ax9.hist(total_centre_diff_filter,histtype='step',bins=np.arange(0,10,step=0.2),label=name)
    ax10.hist(total_h_diff_filter,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)
    ax11.hist(total_w_diff_filter,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)

    ax12.hist(total_area_cov_filter_rad,histtype='step',bins=np.arange(0,1,step=0.025),label=name)
    ax13.hist(total_centre_diff_filter_rad,histtype='step',bins=np.arange(0,10,step=0.2),label=name)
    ax14.hist(total_h_diff_filter_rad,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)
    ax15.hist(total_w_diff_filter_rad,histtype='step',bins=np.arange(-2,2,step=0.1),label=name)
